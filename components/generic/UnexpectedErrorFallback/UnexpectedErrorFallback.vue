<template>
  <div class="unexpected-error-fallback">
    <div
      class="unexpected-error-fallback__overlay"
      :class="{ 'full-height': !displaySuggestions }"
    >
...
import { useNotFoundStore } from '~/stores/api/not-found' // Adjust this path to match your structure
...
const { items } = storeToRefs(notFoundStore)
</script>
