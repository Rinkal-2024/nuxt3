...
const props = defineProps({
  ...
  image: { type: Object as PropType<Record<string, any>>, required: true },
  ...
  linkDescription: { type: Boolean, default: false }
})

// Simulate Nuxt 2's `$isAMP`. You can use useAmp() if using Nuxt AMP module
const isAmp = false // replace with a proper check if needed
</script>

<style lang="scss" scoped>
// If you're using Nuxt 3 with `style-resources`, make sure the mixins are loaded globally
